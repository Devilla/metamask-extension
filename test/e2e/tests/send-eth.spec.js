    ...
    await withFixtures(
      ...
      async ({ driver }) => {
        ...
        await driver.clickElement(
          '[data-testid="advanced-setting-show-testnet-conversion"] .settings-page__content-item-col > label',
        );
        ...
        await driver.clickElement(
          '[data-testid="advanced-setting-advanced-gas-inline"] .settings-page__content-item-col > label',
        );
